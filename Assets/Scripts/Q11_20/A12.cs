        ...
        for (int h = 0; h < height; h++)
        {
            for (int w = 0; w < width; w++)
            {
                ...
                if (h == 0)
                {
                    ...
                    if (w == 0)
                    {
                        color = pixels[pxIndex] + pixels[pxIndex + width + 1];
                    }
                    // 右端
                    else if (w == width - 1)
                    {
                        color = pixels[pxIndex];
                    }
                    else
                    {
                        color = pixels[pxIndex] + pixels[pxIndex + width + 1];
                ...
                else if (h == height - 1)
                {
                    ...
                    {
                        color = pixels[pxIndex - width - 1] + pixels[pxIndex];
                    }
                    else
                    {
                        color = pixels[pxIndex - width - 1] + pixels[pxIndex];
                ...
                else
                {
                    ...
                    {
                        color = pixels[pxIndex - width - 1] + pixels[pxIndex] + pixels[pxIndex + width + 1];
                    }
                }
